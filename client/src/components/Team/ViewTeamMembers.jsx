...
import ViewMemberSalesSummary from "./ViewMemberSalesSummary";
...
export default function ViewTeamMembers({ team, monthYear, onClose = () => { } }) {
                                            ...
                                            .map((member) => (
                                                <tr key={member.id}>
                                                    <td className="text-left font-medium">
                                                        <button
                                                            type="button"
                                                            className="cursor-pointer text-left text-nissan-black underline-offset-2 hover:text-nissan-red hover:underline"
